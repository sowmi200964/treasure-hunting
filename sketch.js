...
var hurdles,hurdlesG,hurdlesImg;
...
function setup(){
  ...
  boy.addAnimation("sumadhvaRunning",boyImg);
  boy.scale = 0.08;
...
function draw() {
  ...
  if(path.y > height ){
   ...
   // else if(swordGroup.isTouching(boy) ||  hurdlesG.isTouching(boy)){
      else if(boy.isTouching(swordGroup)){
      
        gameState = END;
        
        boy.addAnimation("sumadhvaRunning",endImg);
        boy.x = width/2;
        boy.y = height/2;
        boy.scale = 0.4;}}
      ...
      if(gameState === END){
        ...
        //hurdlesG.destroyEach(); 
      
        cashG.setVelocityYEach(0);
        diamondsG.setVelocityYEach(0);
        jwelleryG.setVelocityYEach(0);
        swordGroup.setVelocityYEach(0);
        //hurdlesG.setVelocityEach(0);
...
function createhurdles(){
  ...
  hurdles.scale=0.1;
  hurdles.velocityY = 8;
  hurdles.lifetime = 210;
  hurdlesG.add(hurdles)
  }
} 
